...
<p align="center">
  <img src="testzip/sehatizipzip/client/public/logo.png" alt="SEHATI Logo" width="200" />
</p>
...
│   │   │   ├── health-card.tsx # Health card display
│   │   │   ├── layout.tsx     # App layout
│   │   │   ├── qr-scan.tsx    # QR scanner (for doctors)
│   │   │   ├── qr-share.tsx   # QR generator (for patients)
...
│   ├── services/
│   │   ├── blockchain.ts      # Lisk blockchain service
...
2. Set environment variables di Secrets tab
3. Klik "Run" untuk development
4. Klik "Deploy" untuk production
