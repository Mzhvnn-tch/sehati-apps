      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 z-10 text-center mt-[-4rem]">
        ...
        <div className="grid md:grid-cols-2 gap-6 mt-16 max-w-4xl w-full">
          <Link href="/patient">
            <motion.div 
              whileHover={{ y: -5 }}
              className="group cursor-pointer bg-white rounded-2xl p-8 shadow-xl shadow-gray-200/50 border border-gray-100 text-left relative overflow-hidden"
            >
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center text-primary font-medium group-hover:translate-x-1 transition-transform">
                  Enter as Patient <ArrowRight className="w-4 h-4 ml-2" />
                </div>
              </div>
            </motion.div>
          </Link>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center text-cyan-600 font-medium group-hover:translate-x-1 transition-transform">
                  Enter as Doctor <ArrowRight className="w-4 h-4 ml-2" />
                </div>
              </div>
            </motion.div>
          </Link>
